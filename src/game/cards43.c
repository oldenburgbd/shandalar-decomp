...
int Game_CardScript434c40(int a, int b, int kind)
{
    ...
    if (kind == 0x73) {
        return Game_Helper441699(a, 3, 2) != 0
...
int Game_CardScript432575(int a, int b, int kind)
{
    ...
    if (kind == 0x73) {
        return Game_Helper441699(a, 7, 2) != 0
...
int Game_CardScript43d798(int a, int b, int kind)
{
    ...
    if (kind == 0x74) {
        Game_Helper4c4263(0);
        return Game_Helper4be650(0, 0, a, 2, 2, 0x200, 0x1047, 0, 0, Game_Helper488cc4(a, b), 0, 0, -1, -1, -1, -1, 0, 0, 0);
    }
    if (kind == 0x6c
        && g_game951bdc == b
        && g_game8e1aa8 == a) {
...
int Game_CardScript45862c(int a, int b, int kind)
{
    ...
    if (kind == 0x73) {
        return (g_gameSlots[a][b].flags08 & 0x10) == 0
            && ((g_gameSlots[a][b].flags08 & 0x30000) == 0 || (g_gameCards[g_gameSlots[a][b].field6c].flags & 0x2) == 0)
