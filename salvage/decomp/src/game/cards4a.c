/* Shandalar game layer: card behaviour scripts at 0x4Axxxx.
 *
...
/* Three kinds in one script, and the 0x3b arm chains two helper calls that both
 * have to answer non-zero. */
